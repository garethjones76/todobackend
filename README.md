...
==============================================================
The point of the Release environment is to allow automated UAT testing. In "Section 3 - Acceptance Testing:" we defined our mocha UAT tests in a project call todobacked-specs. We now need to add a service to run these against our Release environment.


Our Release image and Application artefacts are now release candidates that can be published for deployment into test/staging/prod environments.
 The test service:
 	vi 
